-- =====================================================
-- JEFF NIPPARD SCIENCE-BASED PPL (A/B SPLIT)
-- Optimizado para Ectomorfo (Hardgainer)
-- =====================================================

-- IMPORTANTE: Este script REEMPLAZA los ejercicios existentes
-- Ejecutar SOLO si quieres la rutina exacta de Jeff Nippard

-- =====================================================
-- 1. LIMPIAR TABLA DE EJERCICIOS
-- =====================================================

TRUNCATE TABLE health_exercises CASCADE;

-- =====================================================
-- 2. INSERTAR EJERCICIOS CON METADATA COMPLETA
-- =====================================================
...
-- Mostrar todos los ejercicios con sus notas
SELECT 
  name,
  muscle_group,
  exercise_type,
  movement_pattern,
  rep_range_min || '-' || rep_range_max as rep_range,
  rest_timer_seconds || 's' as rest,
  notes
FROM health_exercises
ORDER BY 
...
-- NOTA: Después de ejecutar este script, las rutinas PPL
-- en health_routines seguirán existiendo pero necesitarás
-- actualizar los exercise_id en health_routine_exercises
-- para que apunten a estos nuevos ejercicios.
